...
const weatherapp = async (e) => {
    ...
    const response = await fetch(`https://api.weatherapi.com/v1/current.json?key=503e5d28625c4c2caa5161051230107&q=${input.value}&aqi=yes
    `);
    ...
    //         con5.style.backgroundImage = "url('https://www.pexels.com/photo/scenic-view-of-clouds-during-dawn-1269777/')";
        ...
        else if (cell >= 25 && cell < 50) {
            con5.style.backgroundImage = "url('image_6483441.JPG') ";
